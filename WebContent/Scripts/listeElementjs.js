				    ...
				    option.text = $( "#idetape option:selected" ).text();
				     ...
				     var option = document.createElement("option");
					    option.text = $( "#idsemestre option:selected" ).text();
					     ...
					     var module = document.getElementById("idModuleModal"); 
					     var option = document.createElement("option");
						    option.text = $( "#idModule1 option:selected" ).text();
						     option.value=$("#idModule1 option:selected" ).val();
						     module.add(option);
...
/* ------------------------------------------------------------------------------------------------ */
		 ...
		 var idetape = document.getElementById("idetape");
		 var idsemestre= document.getElementById("idsemestre");
		 var idmodule= document.getElementById("idModule1");
...
/* ------------------------------------------------------------------------------------------------ */	
	$("#SelectSemestre").submit(function(e) {
         ...
         var a = document.getElementById("idModule1");
         $('#idModule1').empty();
 ...
 idmodule.onchange = function(){
	
	
	  var form = $("#SelectModule");
...
//---------------------------------------------------------------------------------------------------------------
	$("#SelectModule").submit(function(e) {
		
		
	       
	       var x = document.getElementById("idModule1");

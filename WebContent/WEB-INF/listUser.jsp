...
<!-- /////////////////////////////////////////////////////////// -->
 ...
 <sql:query var="listUser" dataSource="${myDS}">
       SELECT * FROM deliberationdb.user;
    </sql:query>    
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Ajouter Etudiant </span></a>
            ...
            <table class="table table-striped table-hover " id="myTable">
                ...
                <th>
                    ...
                    <td class="NomUser"><c:out value="${user.nom}" /></td>
                     <td class="PrenomUser"><c:out value="${user.prenom}" /></td>
                      <td class="UsernameUser"><c:out value="${user.username}" /></td>
                      <td class="PasswordUser hidetext" ><c:out value="${user.password}" /></td>
                      <td class="RoleUser"><c:out value="${user.role}" /></td>
                    <td><a href="#editEmployeeModal" id="buttonedit" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="listUser?action=delete&id=<c:out value="${user.idUser}" />"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
		...
		<div class="modal-dialog">
            ...
            <form action="listUser" method="post">
					<div class="modal-header">						
						...
						<div class="form-group">
							<label>Password</label>
							<input type="password" id="passworduser" name="password" class="form-control" required>
						</div>

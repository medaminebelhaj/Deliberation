    ...
    <div class="container body">
            ...
            <div class="table-title">
                <div class="row">
                  ...
                  <p style="color:red;"><c:out value="${msg2}"/></p>
                   ...
                   <form method="post" action="" id="SelectUni">         
            <div class="radio">
            <input type="hidden"  name="action" value="GetIdEtape" class="form-control">
							<label><h2>Choisir Annee Unu:</h2></label>
							<select class="select2_multiple form-control" name="idanne" id="idanne">
                            <c:forEach var="user1" items="${list1.rows}">
                              
                                    <option value=<c:out value="${user1.idanneuni}"/>><c:out value="${user1.anneuni}"/>      </option>
                              </c:forEach>
                            </select>
						 <br>
						</div>
      ...
      <form  id="SelectFiliere">      
        ...
        <form method="post" action="" id="SelectSemestre">         
            <div class="radio">
            <input type="hidden"  name="action" value="GetAllModulebySemester" class="form-control">
			...
			<div class="modal-body">	
				<form method="post" action="listModule">
					<div class="modal-header">						
						...
						<div class="form-group">
							<label><h2>Semestre :</h2></label>
							<select class="select2_multiple form-control" id="idSemestre_FK" name="idSemestre_FK">
						...
						<div class="form-group">
							...
							<input type="text" id="NomModule1" name="NomModule" class="form-control" required>
						
						</div>
						<div class="form-group">
							<label>La Note de Validation</label>
					<input type="text" id="NoteValidationModule1" name="NoteValidationModule" class="form-control" required>
						</div>
						<div class="form-group">
							<label>La Note Eliminatoire</label>
					<input type="text" id="NoteEliminatoireModule1" name="NoteEliminatoireModule" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Coefficiant</label>
					<input type="text" id="CoifficientModule" name="CoifficientModule" class="form-control" required>
						</div>
						<div class="form-group">
						...
						<select class="select2_multiple form-control" aria-label="Default select example">
                             <option selected>Contient des Elements </option>
			...
			<div class="modal-body">	
				<form method="post" action="listModule">
					<div class="modal-header">						
						...
						<div class="form-group">
							<label></label>
								<input type="hidden" id="idModule" name="idModule" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Nom de module</label>
							<input type="text" id="NomModule" name="NomModule" class="form-control" required>
						
						</div>
						<div class="form-group">
							<label>La Note de Validation</label>
					<input type="text" id="NoteValidationModule" name="NoteValidationModule" class="form-control" required>
						</div>
						<div class="form-group">
							<label>La Note Eliminatoire</label>
					<input type="text" id="NoteEliminatoireModule" name="NoteEliminatoireModule" class="form-control" required>
						</div>
...
<style>
  ...
  body {
    ...
    <script src="build/js/custom.min.js"></script>
     <script src="Scripts/ListeEtudiantjs.js"></script>
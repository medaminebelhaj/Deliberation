 ...
 <sql:setDataSource
    ...
    />
     ...
     <sql:query var="listFiliere" dataSource="${myDS}">
       SELECT * FROM deliberationdb.etudiantinscriptionenlignevalide ;
    </sql:query>
               ...
               <c:forEach var="user" items="${listFiliere.rows}">
                    ...
                    <tr>
                      ...
                      <td> <c:out value="${user.mention}" /></td>
                       ...
                       <td><a href="InscriptionAdmServlet?action=valide&id=<c:out value="${user.massaretudiant}" />">Valide</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="InscriptionAdmServlet?action=delete&id=<c:out value="${user.massaretudiant}" />">Delete</a> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a></td>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(document).on("click", ".editEmployeeModal", function () {
		     var myBookId = $(this).data('name');
		     $(".modal-body #name").val( myBookId );
